...
T_max=2*T_max_in;
% n_pu_to_two=2*T_to_both/P_max; % input
% n_pu_to_one=T_to_single/P_max ; % input
% n_pu_maxcon_two=2*T_con/P_max;
% n_pu_maxcon_one=n_pu_maxcon_two/2;
% n_pu_maxclimb_two=2*T_climb/P_max;
% n_pu_maxclimb_one=n_pu_maxclimb_two/2;
% n_pu_maxcruise_two=2*T_cruise/P_max;
